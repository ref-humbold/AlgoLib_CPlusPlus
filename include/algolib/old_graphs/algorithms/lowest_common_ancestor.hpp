...
namespace impl
{
    ...
    {
    public:
        explicit lca_finder(const algolib::graphs::tree_graph & treegraph) : graph{treegraph}
        {
    ...
    private:
        ...
        const algolib::graphs::tree_graph & graph;  //!< Reprezentacja drzewa.
...
namespace algolib
{
    namespace graphs
    {
         ...
         * \return najniższy wspólny przodek
         */
        int find_lca(const tree_graph & treegraph, int vertex1, int vertex2, int root = 0);
    }
}
