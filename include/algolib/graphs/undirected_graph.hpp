...
namespace algolib::graphs
{
    ...
    public:
        ...
        size_t input_degree(const typename undirected_simple_graph<V, VP, EP>::vertex_type & vertex)
                const override
        {
            return this->representation.adjacent_edges(vertex).size();
        }
        ...
        std::vector<typename undirected_simple_graph<V, VP, EP>::edge_type> edges() const override;
