...
std::vector<int> to_vector(alsth::leftist_heap<int> heap)
{
...
protected:
    ...
    const int maximum;
    alsth::leftist_heap<int> test_object;
...
public:
    ...
    ~LeftistHeapTest() override = default;
};

TEST_F(LeftistHeapTest, empty_WhenEmpty_ThenTrue)
{
    // when
...
TEST_F(LeftistHeapTest, empty_WhenNotEmpty_ThenFalse)
{
    // when
...
TEST_F(LeftistHeapTest, size_WhenEmpty_ThenZero)
{
    // when
...
TEST_F(LeftistHeapTest, size_WhenNotEmpty_ThenNumberOfElements)
{
    // when
...
TEST_F(LeftistHeapTest, clear_WhenNotEmpty_ThenEmpty)
{
    // when
    test_object.clear();
    // then
...
TEST_F(LeftistHeapTest, push_WhenEmpty_ThenAdded)
{
    // given
...
TEST_F(LeftistHeapTest, push_WhenNewElementLessThanMaximum_ThenAdded)
{
    // when
...
TEST_F(LeftistHeapTest, push_WhenNewElementGreaterThanMaximum_ThenNewMaximum)
{
    // given
...
TEST_F(LeftistHeapTest, emplace_WhenNewElementLessThanMaximum_ThenAdded)
{
    // when
...
TEST_F(LeftistHeapTest, emplace_WhenNewElementGreaterThanMaximum_ThenNewMaximum)
{
    // given
    int element = maximum + 3;
    // when
...
TEST_F(LeftistHeapTest, top_WhenEmpty_ThenOutOfRange)
{
    // when
...
TEST_F(LeftistHeapTest, top_WhenSingleElement_ThenThisElement)
{
    // given
    int element = numbers[0];
...
TEST_F(LeftistHeapTest, top_WhenMultipleElements_ThenMaximalElement)
{
    // when
    int result = test_object.top();
    // then
...
TEST_F(LeftistHeapTest, pop_WhenEmpty_ThenOutOfRange)
{
    // given
    test_object = alsth::leftist_heap<int>();
    // when
...
TEST_F(LeftistHeapTest, pop_WhenSingleElement_ThenThisElementRemoved)
{
    // given
...
TEST_F(LeftistHeapTest, pop_WhenMultipleElements_ThenMaximalElementRemoved)
{
    // when
    test_object.pop();
    // then
...
TEST_F(LeftistHeapTest, pop_WhenMultipleCalls_ThenSortedDescending)
{
    // given
...
TEST_F(LeftistHeapTest, operatorPlusEqual_WhenEmptyAndNotEmpty_ThenSameAsOther)
{
    // given
    test_object = alsth::leftist_heap<int>();
...
TEST_F(LeftistHeapTest, operatorPlusEqual_WhenNotEmptyAndEmpty_ThenNoChanges)
{
    // when
    test_object += alsth::leftist_heap<int>();
    // then
...
TEST_F(LeftistHeapTest, operatorPlusEqual_WhenOtherHasLessMaximum_ThenMaximumRemains)
{
    // given
...
TEST_F(LeftistHeapTest, operatorPlusEqual_WhenOtherHasGreaterMaximum_ThenNewMaximum)
{
    // given
...
TEST_F(LeftistHeapTest, operatorPlusEqual_WhenSharedInnerHeap_ThenChangedOnlyMergingHeap)
{
    // given
...
TEST_F(LeftistHeapTest, operatorPlus_WhenEmptyAndNotEmpty_ThenSameAsOther)
{
    // given
    test_object = alsth::leftist_heap<int>();
...
TEST_F(LeftistHeapTest, operatorPlus_WhenNotEmptyAndEmpty_ThenNoChanges)
{
    // when
...
TEST_F(LeftistHeapTest, operatorPlus_WhenOtherHasLessMaximum_ThenMaximumRemains)
{
    // given
    alsth::leftist_heap<int> other = {maximum - 5, maximum - 13, maximum - 20};
    // when
...
TEST_F(LeftistHeapTest, operatorPlus_WhenOtherHasGreaterMaximum_ThenNewMaximum)
{
    // given
    std::vector<int> elements = {maximum + 3, maximum - 5, maximum - 13, maximum - 20};
    alsth::leftist_heap<int> other(elements.begin(), elements.end());
...
TEST_F(LeftistHeapTest, operatorPlus_WhenSharedInnerHeap_ThenChangedOnlyMergingHeap)
{
    // given
    std::vector<int> first_elements = {4, 8};
    std::vector<int> second_elements = {10, 20};
