...
protected:
    ...
    std::unordered_map<typename Graph::vertex_type, weight_t> from_list(
            const std::vector<weight_t> & distances, const Graph & graph)
    {
...
TEST_F(PathsTest, floyd_warshall__WhenUndirectedGraph)
{
    ...
    std::vector<std::vector<weight_t>> distances = {{0, 4, inf, 3, 11, 10, inf, 8, 12, inf},
        {4, 0, inf, 7, 7, 8, inf, 10, 10, inf}, {inf, inf, 0, inf, inf, inf, 8, inf, inf, 11},
        {3, 7, inf, 0, 8, 7, inf, 5, 9, inf}, {11, 7, inf, 8, 0, 1, inf, 3, 3, inf},
        {10, 8, inf, 7, 1, 0, inf, 2, 2, inf}, {inf, inf, 8, inf, inf, inf, 0, inf, inf, 3},
        {8, 10, inf, 5, 3, 2, inf, 0, 4, inf}, {12, 10, inf, 9, 3, 2, inf, 4, 0, inf},
