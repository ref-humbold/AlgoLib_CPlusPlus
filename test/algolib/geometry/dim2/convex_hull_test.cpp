 ...
 * \brief Tests: Algorithm for convex hull in 2D (Graham's scan).
 */
...
{
    // when
    std::vector<alge2::point_2d> result = alge2::find_convex_hull({alge2::point_2d(1, -3),
        alge2::point_2d(-4, 6), alge2::point_2d(-5, -7), alge2::point_2d(-8, -7),
        alge2::point_2d(-3, -4), alge2::point_2d(5, 9), alge2::point_2d(-1, -8),
        alge2::point_2d(-5, 10), alge2::point_2d(8, 0), alge2::point_2d(3, -6),
        alge2::point_2d(-2, 1), alge2::point_2d(-2, 8), alge2::point_2d(10, 2),
        alge2::point_2d(6, 3), alge2::point_2d(-7, 7), alge2::point_2d(6, -4)});

    // then
    EXPECT_EQ(std::vector<alge2::point_2d>({alge2::point_2d(-1, -8), alge2::point_2d(3, -6),
                  alge2::point_2d(6, -4), alge2::point_2d(10, 2), alge2::point_2d(5, 9),
                  alge2::point_2d(-5, 10), alge2::point_2d(-7, 7), alge2::point_2d(-8, -7)}),
            result);
}
...
TEST(ConvexHullTest, findConvexHull_WhenMultiplePointsAreCollinear_ThenInnerPointsOmitted)
{
    // when
    std::vector<alge2::point_2d> result =
            alge2::find_convex_hull({alge2::point_2d(-1, -3), alge2::point_2d(-3, -3),
                alge2::point_2d(-3, -1), alge2::point_2d(2, -3), alge2::point_2d(-3, 5),
                alge2::point_2d(0, -3), alge2::point_2d(7, -3), alge2::point_2d(-3, -2)});
