...
{
    // given
    std::vector<alge2::point_2d> sequence = {alge2::point_2d(0.0, 0.0), alge2::point_2d(-2.0, -3.0),
    ...
    EXPECT_EQ(std::vector<alge2::point_2d>({alge2::point_2d(-3.0, 2.0), alge2::point_2d(-3.0, -2.0),
                  ...
                  alge2::point_2d(0.0, 0.0), alge2::point_2d(2.0, 3.0), alge2::point_2d(2.0, -3.0),
...
TEST(Geometry2DTest, sortByY_ThenSortedStablyAscending)
{
    ...
    EXPECT_EQ(std::vector<alge2::point_2d>({alge2::point_2d(-2.0, -3.0), alge2::point_2d(2.0, -3.0),
                  alge2::point_2d(3.0, -2.0), alge2::point_2d(-3.0, -2.0),
                  alge2::point_2d(0.0, 0.0), alge2::point_2d(-3.0, 2.0), alge2::point_2d(3.0, 2.0),
                  alge2::point_2d(2.0, 3.0), alge2::point_2d(-2.0, 3.0)}),
            sequence);
}
...
TEST(Geometry2DTest, sortByAngle_ThenSortedAscending)
{
    ...
    EXPECT_EQ(std::vector<alge2::point_2d>({alge2::point_2d(0.0, 0.0), alge2::point_2d(3.0, 2.0),
                  alge2::point_2d(2.0, 3.0), alge2::point_2d(-2.0, 3.0), alge2::point_2d(-3.0, 2.0),
...
{
    // given
    std::vector<alge2::point_2d> sequence = {alge2::point_2d(0.0, 0.0), alge2::point_2d(1.0, 1.0),
        alge2::point_2d(-2.0, -2.0), alge2::point_2d(-3.0, -3.0), alge2::point_2d(4.0, 4.0)};
