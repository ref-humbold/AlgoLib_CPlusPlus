...
TEST_F(DisjointSetsTest, testUnionSetWhenDifferentSets)
{
    ...
    ASSERT_TRUE(test_object.is_same_set(elem1, elem2));
    ASSERT_EQ(test_object.find_set(elem1), test_object.find_set(elem2));
}
...
TEST_F(DisjointSetsTest, testUnionSetWhenSameSets1)
{
    ...
    ASSERT_TRUE(test_object.is_same_set(elem, elem));
    ASSERT_EQ(test_object.find_set(elem), test_object.find_set(elem));
}
