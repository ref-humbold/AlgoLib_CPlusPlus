...
double alge2::vector_2d::area(const vector_2d & v1, const vector_2d & v2)
{
    return v1.x() * v2.y() - v1.y() * v2.x();
}

alge2::vector_2d & alge2::vector_2d::operator+=(const vector_2d & v)
{
    x_ += v.x();
    y_ += v.y();
    return *this;
...
alge2::vector_2d alge2::operator+(vector_2d v)
{
    v.x_ = +v.x_;
    v.y_ = +v.y_;
    return v;
...
alge2::vector_2d alge2::operator+(vector_2d v1, const vector_2d & v2)
{
    v1 += v2;
    return v1;
}
...
alge2::vector_2d alge2::operator*(vector_2d v, double c)
{
    v *= c;
    return v;
}

alge2::vector_2d alge2::operator*(double c, vector_2d v)
{
    v *= c;
    return v;
}
