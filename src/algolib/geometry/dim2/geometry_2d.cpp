...
void alge2::sort_by_x(std::vector<point_2d> & points)
{
...
{
    auto comparator = [&](const point_2d & pt1, const point_2d & pt2)
    {
        angle_2d angle1 = pt1.angle(), angle2 = pt2.angle();
...
alge2::point_2d alge2::translate(const point_2d & point, const vector_2d & vector)
{
    return point_2d(point.x() + vector.x(), point.y() + vector.y());
}

alge2::point_2d alge2::reflect(const point_2d & point, const point_2d & centre)
{
